...
router.get('/:id', (0, auth_1.default)('STUDENT', 'FACULTY', 'ADMIN'), course_controller_1.CourseControllers.getSingleCourse);
router.patch('/:id', (0, auth_1.default)('ADMIN'), (0, validateRequest_1.default)(course_validation_1.CourseValidations.updateCourseValidationSchema), course_controller_1.CourseControllers.updateCourse);
